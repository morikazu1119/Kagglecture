...
summary: Accuracy、Precision、Recall、F1、AUC、LogLoss、RMSE、MAE、Dice、IoU。
type: category-index
nav_order: 2
...
<div class="dictionary-grid">
  ...
  <a class="dictionary-card dictionary-card-link" href="{{ '/wiki/metrics/dice-iou.html' | relative_url }}" aria-label="Dice / IoU を開く"><h3>Dice / IoU</h3><p>予測maskと正解maskの重なりを測るSegmentationの代表指標。</p></a>
